...
# Set execution policy to unrestricted at the beginning of the script
...
# Reset execution policy to restricted at the end of the script
Set-ExecutionPolicy Restricted -Force
Write-VerboseLog "Execution policy set to Restricted."